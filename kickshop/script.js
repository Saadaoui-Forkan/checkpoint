...
btn1.addEventListener('click',()=>btn1.style.color='#e90000');

let btn2=document.querySelector('#like2');
btn2.addEventListener('click',()=>btn2.style.color='#e90000');

let btn3=document.querySelector('#like3');
btn3.addEventListener('click',()=>btn3.style.color='#e90000');

let btn4=document.querySelector('#like4');
btn4.addEventListener('click',()=>btn4.style.color='#e90000');

let btn5=document.querySelector('#like5');
btn5.addEventListener('click',()=>btn5.style.color='#e90000');

let btn6=document.querySelector('#like6');
btn6.addEventListener('click',()=>btn6.style.color='#e90000');